...
eos1 = driver(hostname= 'localhost', username='arista',password='arista', optional_args={'port': 443})


eos2 = driver(hostname= 'localhost', username='arista',password='arista', optional_args={'port': 8443})
